...
\begin{itemize}
	\item Los dos tipos de aprendizaje mas usuales son: \color{darkgreen}{supervisado} \color{black} y 
	\color{blue}no supervisado\color{black}.

	\vspace{5mm}	
	\item Las tareas a realizar suelen clasificarse en estas categorías: 
	\begin{itemize}
		\color{darkgreen} % SUPERVISADO
		\item Clasificación
		\item Regresión
...
\begin{figure}[t]
	\begin{center}
		...
		{imagenes/machinelearningexamples}
	\end{center}
\end{figure}
	...
	\begin{tabular}{l}
		\parbox{0.5\linewidth}{
			\begin{itemize}
				...
				\end{itemize} 
				\item Multi-lenguaje: Español e Inglés
			\end{itemize}
		}
	\end{tabular} 
	&
...
\frametitle {Prueba Nº 2}
\begin{itemize}
	\item \small{\textbf{\color{darkgreen}Accuracy:} 63\%}
...
\begin{itemize}
	...
	\begin{center}
		$\Rightarrow$ Todas las pruebas pasaron los criterios de aceptación definidos
	\end{center}
