...
\begin{itemize}
	...
	\vspace{2mm}
	\item Implementar el algoritmo de procesamiento y extracción de características \textbf{on premise}.
	\vspace{2mm}
	\item Asistir al usuario, brindando \textbf{herramientas de administración} para que pueda interactuar con el resultado.
	\vspace{2mm}
	\item Procesar un total de \textbf{400 imágenes} en simultaneo.
\end{itemize}
