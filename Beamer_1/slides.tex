...
\begin{frame}[t,fragile]
	...
	%	\item El framework será pensado para ser reutilizado por desarrolladores, por lo que se prioriza su estructuración simple y fácil legibilidad en el código. A raíz de ello, se decide utilizar Python como lenguaje de programación.
	...
	%	\item Se debe tener la posibilidad de realizar el trabajo de cómputo distribuido, tanto a nivel clúster como a nivel local (sobre los hilos de ejecución de una sola computadora).
...
\begin{enumerate}{}
	...
	\vspace{4mm}
	\item Administración del resultado arrojado por el procesamiento.
	\vspace{4mm}
	\item Administración del resultado final.
\end{enumerate}
	...
	\begin{tabular}{l}
		\parbox{0.5\linewidth}{
			\begin{itemize}
				...
				\vspace{3mm}
				\begin{itemize}
					\item Se encuentran preparados y optimizados para ser utilizadas en dispositivos móviles.
					\item Pueden descargarse con sus pesos sinópticos entrenados.
					\vspace{2mm}
					\item Pueden ser adaptados según la necesidad del proyecto. 
					\vspace{2mm}
...
\begin{itemize}
	...
	\item A partir de una imagen de entrada, devuelve el grado de similitud que tiene con los 1001 grupos con los que cuenta la red.
\end{itemize}
\begin{figure}[t]
	\begin{center}
...
\begin{itemize}
	...
	\item Jerarquía: parten desde una madre o genérica, hacia el detalle en concreto.
\end{itemize} 
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.5\textwidth]%
...
%---------------------------------------
\begin{frame}[t,fragile]
\frametitle {Etapa 1: Pre-procesamiento y extracción de característica}
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.8\textwidth]%
...
Por cada imagen:
\begin{enumerate}
	\item Se obtiene una lista de las 5 (o menos) etiquetas cuyas probabilidades fueron las más altas.
	\vspace{2mm}
	\item Por cada una de ellas se obtienen las 4 etiquetas ``padres'' según \textbf{WordNet}, asignándole la misma probabilidad que la ``hija''.
\end{enumerate}
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.5\textwidth]%
...
\end{itemize}
\begin{block}{}
	Los \textit{embeddings} representan como se activó la última capa antes de realizar la clasificación, y puede ser entendida como una noción de distancia entre las imágenes.
\end{block}
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.4\textwidth]%
...
\begin{block}{}
	Por cada imagen: 
	\begin{itemize}
		\item Se obtiene un conjunto de etiquetas y probabilidades.
...
\begin{itemize}
	...
	\end{enumerate}
	\vspace{6mm}
	\item Se registra en una matriz el grado de similitud entre cada par de imágenes.
\end{itemize}
\vspace{6mm}
\begin{center}
...
\begin{block}{}
	Para realizar el agrupamiento de las imágenes se utilizó el algoritmo de Markov (\textbf{MCL}), desarrollado por Stijn van Dongen.
\end{block}
\vspace{5mm}
\begin{figure}[t]
	\begin{center}
...
\begin{itemize}
	...
	\begin{figure}[t]
		...
		\end{center}
	\end{figure}
	\item \small{Se realizó un protocolo de validación de todos los módulos que componen la aplicación, con el objetivo de validar que se comporta y actúa según lo esperado. Ejemplo:}
	\begin{figure}[t]
		\begin{flushright}
			\includegraphics[width=0.75\textwidth]%
			{imagenes/prot-validacion-ej}
		\end{flushright}
	\end{figure}
\end{itemize}
